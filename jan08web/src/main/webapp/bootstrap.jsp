    ...
    <body id="page-top">
        ...
        <div class="mt-4"/>
            ...
            <button type="button" class="btn btn-primary">글쓰기</button>
      	    ...
      	    <div class="container bg-info text=white">구역
      	       	<div class="m-5 mb-0 bg-primary w-25">구역2</div>            
	            <div class="mx-2 my-4 py-5 bg-secondary w-50">구역3</div>
	            <div class="my-2 bg-secondary w-75">구역4</div>
            </div>
        ...
        <footer class="bg-black text-center py-5">
            <div class="container px-5">
                <div class="text-white-50 small">
                    <div class="mb-2">&copy; igematna 2024. All Rights Reserved.</div>
                    <a href="#!">Privacy</a>
